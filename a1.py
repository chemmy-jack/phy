...
#flapping angle sheet
try :
    print(file.sheets["flapping"])
except :
    file.sheets.add(name="flapping",after=-1)
a = file.sheets["flapping"]
for i in range(1,nrows+1):
    a["a"+str(i)].value = str(flapping_angle[i-1])
print("flapping angle sheet finnished")
# pitching_file sheettry :
try :
    print(file.sheets["pitching"])
except :
    file.sheets.add(name="pitching",after=-1)
a = file.sheets["pitching"]
for i in range(1,nrows+1):
    a["a"+str(i)].value = str(pitching_angle[i-1])
print("pitching angle sheet finnished")
# sweeping_file sheet
try :
    print(file.sheets["sweeping"])
except :
    file.sheets.add(name="sweeping",after=-1)
a = file.sheets["sweeping"]
for i in range(1,nrows+1):
    a["a"+str(i)].value = str(sweeping_angle[i-1])
